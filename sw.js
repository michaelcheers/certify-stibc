    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between">
        <ul class="navbar-nav">
          ...
          <li class="nav-item lynxseal-auth-only"><a class="nav-link text-dark" href="/">CERTIFY A TRANSLATION</a></li>
          <li class="nav-item"><a class="nav-link text-dark" href="https://verify-stibc-test.lynxseal.com/">VERIFY A DOCUMENT</a></li>
          <li class="nav-item"><a class="nav-link text-dark" href="/how-it-works">FAQ</a></li>
          <li class="nav-item lynxseal-auth-only">
          ...
          <li class="nav-item lynxseal-anon-only">
            <form class="form-inline" action="/sign-in" method="get">
              <button type="submit" class="nav-link btn btn-link text-dark">LOGIN</button>
            </form>
          </li>
          <li class="nav-item lynxseal-anon-only">
            <form class="form-inline" action="/reset-password" method="get">
              <button type="submit" class="nav-link btn btn-link text-dark">RESET PASSWORD</button>
            </form>
          </li>
        </ul>
      </div>
